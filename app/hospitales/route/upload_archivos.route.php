...
$app->group('/hospitales/upload/', function () {
    ...
    $this->post('subir-archivo/{tabla}/{id}', function ($req, $res, $args){
        try {
            ...
            $result=Manejo_Respuesta_WS::respuestas('error',400,'El archivo del producto no ha podido subirse!!!');
            ...
            if(isset($_FILES['archivos_enviados'])){
                ...
                $upload=$libreria_piramide->upload('image-'.$args["id"].".jpg",'archivos_enviados','../app/hospitales/archivos_cargados/'.$args["tabla"],array('image/jpeg','image/png','image/gif'));
